//////////////////////////////////////////////
// ComboBoxEx.cpp
//  Definitions for the CComboBoxEx_Win32xx class

#include "stdafx.h"
#include "ComboBoxEx.h"
#include "resource.h"

CComboBoxEx_Win32xx::CComboBoxEx_Win32xx() : m_himlImages(NULL)
{
	SetImages(3, IDB_STATUS);
}

CComboBoxEx_Win32xx::~CComboBoxEx_Win32xx()
{
	ImageList_Destroy(m_himlImages);
}

void CComboBoxEx_Win32xx::PreCreate(CREATESTRUCT &cs)
{
...
BOOL CComboBoxEx_Win32xx::AddItems()
{
    typedef struct
	{
        int iImage;
...
void CComboBoxEx_Win32xx::SetImages(int nImages, UINT ImageID)
{
	if (m_himlImages)
	{
		ImageList_Destroy(m_himlImages);
