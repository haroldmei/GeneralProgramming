...
const LPCTSTR ERASER_REGISTRY_AUTHOR
    = TEXT("Software\\WinEraser Project");
const LPCTSTR ERASER_REGISTRY_PROGRAM
    = TEXT("Software\\WinEraser Project\\WinEraser");
const LPCTSTR ERASER_REGISTRY_BASE
    = TEXT("Software\\WinEraser Project\\WinEraser\\1.0");
...
typedef enum {
    ...
    ERASER_METHOD_DOD,
    ERASER_METHOD_DOD_E,
    ERASER_METHOD_PSEUDORANDOM } ERASER_METHOD;

#define eraserIsValidMethod(x)  (( (x) >= ERASER_METHOD_LIBRARY ) && \
                                 ( (x) <= ERASER_METHOD_PSEUDORANDOM ))
...
#ifdef _DLL_ERASER
    #define ERASER_EXPORT E_INT32/*__declspec(dllexport) ERASER_RESULT __stdcall*/
#else
    #define ERASER_EXPORT E_INT32/*__declspec(dllimport) ERASER_RESULT __stdcall*/
#endif
...
ERASER_EXPORT
eraserCreateContextEx(E_OUT ERASER_HANDLE*, E_IN ERASER_METHOD, E_IN E_UINT16, E_IN E_UINT8);
// destroys a context
ERASER_EXPORT
...
ERASER_EXPORT
eraserAddItemA(E_IN ERASER_HANDLE, E_IN LPVOID, E_IN E_UINT16);
ERASER_EXPORT
eraserAddItemW(E_IN ERASER_HANDLE, E_IN LPVOID, E_IN E_UINT16);
...
ERASER_EXPORT
eraserProgGetMessageA(E_IN ERASER_HANDLE, E_OUT LPVOID, E_INOUT E_PUINT16);
ERASER_EXPORT
eraserProgGetMessageW(E_IN ERASER_HANDLE, E_OUT LPVOID, E_INOUT E_PUINT16);
// returns the name of the item that is being processed
ERASER_EXPORT
eraserProgGetCurrentDataStringA(E_IN ERASER_HANDLE, E_OUT LPVOID, E_INOUT E_PUINT16);
ERASER_EXPORT
eraserProgGetCurrentDataStringW(E_IN ERASER_HANDLE, E_OUT LPVOID, E_INOUT E_PUINT16);
...
ERASER_EXPORT
eraserErrorStringA(E_IN ERASER_HANDLE, E_IN E_UINT16, E_OUT LPVOID, E_INOUT E_PUINT16);
ERASER_EXPORT
eraserErrorStringW(E_IN ERASER_HANDLE, E_IN E_UINT16, E_OUT LPVOID, E_INOUT E_PUINT16);
...
ERASER_EXPORT
eraserFailedStringA(E_IN ERASER_HANDLE, E_IN E_UINT32, E_OUT LPVOID, E_INOUT E_PUINT16);
ERASER_EXPORT
eraserFailedStringW(E_IN ERASER_HANDLE, E_IN E_UINT32, E_OUT LPVOID, E_INOUT E_PUINT16);
...
// removes a file
ERASER_EXPORT
eraserRemoveFileA(E_IN LPVOID, E_IN E_UINT16);
ERASER_EXPORT
eraserRemoveFileW(E_IN LPVOID, E_IN E_UINT16);
// removes a folder
ERASER_EXPORT
eraserRemoveFolderA(E_IN LPVOID, E_IN E_UINT16, E_IN E_UINT8);
ERASER_EXPORT
eraserRemoveFolderW(E_IN LPVOID, E_IN E_UINT16, E_IN E_UINT8);
...
ERASER_EXPORT
eraserGetFreeDiskSpaceA(E_IN LPVOID, E_IN E_UINT16, E_OUT E_PUINT64);
ERASER_EXPORT
eraserGetFreeDiskSpaceW(E_IN LPVOID, E_IN E_UINT16, E_OUT E_PUINT64);

// returns the cluster size of a partition
ERASER_EXPORT
eraserGetClusterSizeA(E_IN LPVOID, E_IN E_UINT16, E_OUT E_PUINT32);
ERASER_EXPORT
eraserGetClusterSizeW(E_IN LPVOID, E_IN E_UINT16, E_OUT E_PUINT32);
...
#elif _UNICODE
	#define eraserAddItem					eraserAddItemW
	#define eraserProgGetMessage			eraserProgGetMessageW
	#define eraserProgGetCurrentDataString	eraserProgGetCurrentDataStringW
	#define eraserErrorString				eraserErrorStringW
	#define eraserFailedString				eraserFailedStringW
	#define eraserRemoveFile				eraserRemoveFileW
	#define eraserRemoveFolder				eraserRemoveFolderW
	#define eraserGetFreeDiskSpace			eraserGetFreeDiskSpaceW
	#define eraserGetClusterSize			eraserGetClusterSizeW
#else
	#define eraserAddItem					eraserAddItemA
	#define eraserProgGetMessage			eraserProgGetMessageA
	#define eraserProgGetCurrentDataString	eraserProgGetCurrentDataStringA
	#define eraserErrorString				eraserErrorStringA
	#define eraserFailedString				eraserFailedStringA
	#define eraserRemoveFile				eraserRemoveFileA
	#define eraserRemoveFolder				eraserRemoveFolderA
	#define eraserGetFreeDiskSpace			eraserGetFreeDiskSpaceA
	#define eraserGetClusterSize			eraserGetClusterSizeA
#endif // #ifdef _DLL_ERASER
